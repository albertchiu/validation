...
import de.malkusch.validation.validator.internal.upload.NotEmptyBlobValidator;
...
public @interface NotEmptyBlob {
	...
	String message() default "{de.malkusch.validation.constraints.upload.NotEmptyBlob.message}";
